  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.linksContainer}>
        <Link style={styles.linksHead} href="/">For You</Link>
        <Link style={styles.linksHead} href="/recent">Recent Information</Link>
        <Link style={styles.linksHeadActivated} href="/recommended">Recommendation</Link>
      </View>
      <ImageBackground
        source={require('../assets/images/tenology-banner.jpg')}
        style={styles.headContainer}>
            <View style={styles.headTextContent}> 
                <Text style={styles.sectionText}>ENTERTAIMENT</Text>
      ...
      <View style={styles.linksNews}>
        ...
        <Link style={styles.linksAll} href="/allnewsen">See All</Link>
      </View>
      <View>
        {articles.length > 0 ? (
            ...
            <TouchableOpacity onPress={() => toWebsite(article.link)} key={index} style={styles.newsContainer}>
              ...
              <View style={styles.newsTextContainer}>
                <View>
                  ...
                  <Text style={styles.newsCategory}>Entertainment</Text>
                </View>
